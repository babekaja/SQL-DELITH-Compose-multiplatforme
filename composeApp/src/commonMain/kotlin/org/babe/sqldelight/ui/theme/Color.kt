...
object AppColors {
    ...
    val Secondary50 = Color(0xFFFAF5FF)
    val Secondary100 = Color(0xFFF3E8FF)
    val Secondary200 = Color(0xFFE9D5FF)
    val Secondary300 = Color(0xFFD8B4FE)
    val Secondary400 = Color(0xFFC084FC)
    val Secondary500 = Color(0xFFA855F7)
    val Secondary600 = Color(0xFF9333EA)
    val Secondary700 = Color(0xFF7C3AED)
    val Secondary800 = Color(0xFF6B21A8)
    val Secondary900 = Color(0xFF581C87)

    // Couleurs d'accent - Vert pour les succès
